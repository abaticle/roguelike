...
export default class BattleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.input.on('pointerdown', (pointer) => {            
            ...
            const ui = this.ecs.get("Game", "game", "ui")
        ...
        console.log(Util.getLinePositions({x: 2, y: 2}, {x: 5, y:8}))
...
//display.sprite = this.add.sprite((32 * position.x) + 16, (32 * position.y) + 16, "monsers1", display.frame)
    ...
    createGameEntity() {
        ...
        this.ecs.set(new BattleSceneUI(this, this.ecs), "Game", "game", "ui")
    }

    /**
     * @returns {BattleSceneUI} Get scene ui
     */
    getUI() {
        return this.ecs.get("Game", "game", "ui")
    }
